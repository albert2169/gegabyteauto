...
class FilterSeriesDropdown extends StatelessWidget {
  const FilterSeriesDropdown({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<FiltersBloc, FiltersState>(
      buildWhen: (previous, current) =>
          previous.selectedSeries != current.selectedSeries ||
          previous.availableSeries != current.availableSeries ||
